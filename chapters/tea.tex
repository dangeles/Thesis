...
enriched in specific tissues~\cite{Gaudet2004a, Spencer2011, Cinar2005,
...
\label{fig:trim_roots}
  ...
  \caption{
    ...
    \csentence{\textbf{a.}} The parent node (green) contains at least as many
	...
	\csentence{\textbf{b.}} Nodes with less than a threshold number of genes are
  ...
  is 25 genes. Nodes $\epsilon, \zeta, \eta$, shown in red are removed.
	\csentence{\textbf{c.}} Parent nodes are removed recursively, starting from
...
\begin{table}[p]
  ...
  % & {\textbf{Method}} & {\textbf{No. Of Terms in Dictionary}}\\\hline,
	% late after line= \\,
