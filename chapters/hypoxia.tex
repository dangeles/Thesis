...
\begin{figure}[tbhp]
\centering
\includegraphics[width=0.65\linewidth]{hypims/pca.pdf}
\caption{
...
increased \hifp{} function is known to cause increased transcription of \gene{rhy-1}
...
to increase,
as they are involved in the \gene{hif-1}-dependent hypoxia response. However,
since \gene{rhy-1} has been mutated, the observed transcriptome is \rhyp{}
...
have \gene{egl-9} independent, \gene{rhy-1}-dependent expression patterns.

We also identified a main hypoxia response induced by disinhibiting
\gene{hif-1} (355 genes) by identifying genes that were commonly upregulated
...
but deletion of \gene{vhl-1} abolishes this induction. Moreover, \citet{Luhachack2012}
